...
HT_TASK::TaskResponse run_read_adc1_task(const unsigned long& sysMicros, const HT_TASK::TaskInfo& taskInfo)
{
    ...
    ThermistorDataInstance::instance().temp_sensor1_adc = ADCSingletonInstance::instance().adc1.data.conversions[THERMISTOR_0].conversion;
    ThermistorDataInstance::instance().temp_sensor2_adc = ADCSingletonInstance::instance().adc1.data.conversions[THERMISTOR_1].conversion;

...
void run_read_adc0_task()
{
    ...
    //hal_printf("Reading ADC 0 LoadCell RL: %d\n", ADC0Instance::instance().data.conversions[RL_LOADCELL_CHANNEL].raw);
    Serial.println(static_cast<int>(initailized_adcs));
}

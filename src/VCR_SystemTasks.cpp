...
VCRInterfaceData_s sample_async_data(VCRInterfaces & interface_ref_container, const VCRInterfaceData_s & cur_vcr_int_data)
{
...
void big_task(VCRInterfaces & interface_ref_container, VCRSystems &systems, VehicleStateMachine& state_machine)
{
    auto interface_data = sample_async_data(interface_ref_container);

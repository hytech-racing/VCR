...
struct VCRAsynchronousInterfaces {
    explicit VCRAsynchronousInterfaces(CANInterfaces_s &can_ints) : can_interfaces(can_ints) {}
...
VCRInterfaceData_s sample_async_data(
    etl::delegate<void(CANInterfaces_s &, const CAN_message_t &, uint32_t)> recv_call,

...
VCRInterfaceData_s
sample_async_data(etl::delegate<void(CANInterfaces &, const CAN_message_t &, unsigned long)> recv_call,
                  VCRInterfaces &interface_ref_container,
                  const VCRInterfaceData_s &cur_vcr_int_data);
// etl::delegate<void(CANInterfaces& , const CAN_message_t& , unsigned long
// )>::create<VCRCANInterfaceImpl::vcr_CAN_recv>();

...
constexpr float CURRENT_SENSOR_SENSITIVITY_V_PER_A  = 0.100f; // 100 mV / A Sensitivity

constexpr float ADS112_CURRENT_SENSOR_SCALE =
    ADS112_VOLTAGE_SCALE / CURRENT_SENSOR_SENSITIVITY_V_PER_A;

constexpr float ADS112_CURRENT_SENSOR_OFFSET =
    -1.0f * (CURRENT_SENSOR_ZERO_CURRENT_VOLTAGE / CURRENT_SENSOR_SENSITIVITY_V_PER_A);
...
constexpr std::array<float, ADS112U04_NUM_CHANNELS> ADS112_SCALES = {
...
constexpr std::array<float, ADS112U04_NUM_CHANNELS> ADS112_OFFSETS = {
